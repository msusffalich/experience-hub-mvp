...
| Meta/Oakley/Ray-Ban | Multimedia y exports desde Meta AI/Galeria | Pendiente hardware/API | Media real importada desde lentes + JSON/HTML de cuenta si aplica | Fotos/videos/voz quedan como activos con origen Meta y procesamiento correcto |
