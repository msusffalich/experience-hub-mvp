...
|---|---|---|---|---|
| Captura Vibeapp -> servidor | La ruta experimental mezcló captura con experiencia y perdió/rechazó elementos reales | Contrato canónico y guard canario listos en 728; cliente móvil pendiente | Implementar en fuente Vibeapp 663+, habilitar un usuario y ejecutar matriz de texto, imagen, audio, video, documento y contexto; sin señal; reinicio; respuesta perdida; reintento | Una sola ruta conserva original, catálogo y recibo; VibePWA muestra el mismo registro; ningún elemento desaparece |
