...
- `resetReportScopeInlineButton`: Limpiar filtros (index.html:765)
- `generateReportButton`: Generar reporte (index.html:771)
- `downloadEditedReportPdfButton`: Descargar PDF (index.html:772)
- `resetReportScopeButton`: Restaurar vista (index.html:773)
- `clearInsightsScopeButton`: Limpiar filtros (index.html:850)
- `exportInsightsPdfButton`: Descargar PDF de hallazgos (index.html:856)
- `exportInsightsHtmlButton`: Descargar HTML (index.html:857)
- `exportInsightsMarkdownButton`: Exportar Markdown (index.html:858)
- `askButton`: Consultar (index.html:871)
- `clearPublicationScopeButton`: Limpiar filtros (index.html:921)
- `generatePublicationButton`: Generar PDF revista premium (index.html:956)
- `exportPublicationPdfButton`: Descargar PDF revista premium (index.html:957)
- `exportPublicationPackageButton`: Descargar PDF + videos (index.html:958)
- `launchPublicationChannelButton`: Preparar canal (index.html:959)
- `previewPublicationHtmlButton`: Vista imprimible (index.html:967)
- `exportPublicationHtmlButton`: Exportar HTML (index.html:968)
- `exportPublicationMarkdownButton`: Exportar Markdown (index.html:969)
- `copyPublicationTextButton`: Copiar texto (index.html:970)
- `copyPublicationHtmlButton`: Copiar HTML (index.html:971)
- `manualClearSearchButton`: Limpiar búsqueda (index.html:1063)
- `manualExportMarkdownButton`: Exportar Markdown (index.html:1064)
- `manualExportPdfButton`: Descargar manual PDF (index.html:1065)
- `manualExportHtmlButton`: HTML imprimible (index.html:1066)
- `manualMarkAllButton`: Marcar todo (index.html:1067)
- `manualResetReviewButton`: Reiniciar revisión (index.html:1068)
- `embeddingBackfillButton`: Reindexar busqueda (index.html:1085)
- `workspaceBackfillButton`: Reparar estructura (index.html:1086)
- `refreshOpsButton`: Actualizar panel (index.html:1087)
- `syncOfflineButton`: Actualizar datos del servidor (index.html:1088)
- `supabaseDiagnosticsButton`: Revisar conexion (index.html:1089)
- `supabaseSelfTestButton`: Probar nube completa (index.html:1090)
- `openAdvancedDiagnosticsButton`: Diagnostico avanzado (index.html:1091)
- `privacyRecommendedButton`: Aplicar recomendado (index.html:1117)
- `toggleLocalKeyButton`: Mostrar clave (index.html:1118)
- `rotateLocalKeyButton`: Aplicar clave (index.html:1119)
- `unlockLocalButton`: Desbloquear local (index.html:1120)
- `exportAssetInventoryButton`: Exportar inventario (index.html:1172)
- `exportAssetInventoryCsvButton`: CSV inventario (index.html:1173)
- `exportAssetProcessingBacklogButton`: Exportar pendientes (index.html:1174)
- `exportAssetProcessingBacklogCsvButton`: CSV pendientes (index.html:1175)
- `exportAssetProcessingChecklistButton`: Checklist de revisión (index.html:1176)
- `exportAssetMetadataTemplateButton`: Plantilla CSV (index.html:1177)
- `exportAssetEditableMetadataCsvButton`: CSV edición (index.html:1178)
- `suggestFilteredAssetTextButton`: Sugerir texto filtrado (index.html:1179)
- `importAssetMetadataButton`: Importar metadatos (index.html:1180)
- `saveProfileButton`: Guardar perfil (index.html:1238)
