...
- Documentos historicos o de soporte: 31.
...
- `recordAudioButton`: Grabar audio (index.html:408)
- `clearAssetFiltersButton`: Limpiar filtros (index.html:477)
- `importBiometricAssetButton`: Importar histórico (index.html:502)
- `exportAgendaIcsButton`: Exportar calendario (index.html:540)
- `importAgendaIcsButton`: Importar .ics (index.html:541)
- `agendaSaveBlockedDatesButton`: Guardar bloqueos (index.html:549)
- `agendaClearButton`: Limpiar (index.html:616)
- `agendaSaveButton`: Guardar evento (index.html:617)
- `experienceMapExportButton`: Exportar mapa y notas (index.html:682)
- `connectLocalObsidianVaultButton`: Conectar bóveda del PC (index.html:686)
- `forgetLocalObsidianVaultButton`: Quitar conexión local (index.html:687)
- `experienceMapAskButton`: Consultar (index.html:693)
- `resetReportScopeInlineButton`: Limpiar filtros (index.html:783)
- `generateReportButton`: Generar reporte (index.html:789)
- `downloadEditedReportPdfButton`: Descargar PDF (index.html:790)
- `resetReportScopeButton`: Restaurar vista (index.html:791)
- `clearInsightsScopeButton`: Limpiar filtros (index.html:868)
- `exportInsightsPdfButton`: Descargar PDF de hallazgos (index.html:874)
- `exportInsightsHtmlButton`: Descargar HTML (index.html:875)
- `exportInsightsMarkdownButton`: Exportar Markdown (index.html:876)
- `askButton`: Consultar (index.html:889)
- `clearPublicationScopeButton`: Limpiar filtros (index.html:957)
- `generatePublicationButton`: Generar PDF revista premium (index.html:980)
- `exportPublicationPdfButton`: Descargar PDF revista premium (index.html:981)
- `exportPublicationPackageButton`: Descargar PDF + videos (index.html:982)
- `launchPublicationChannelButton`: Preparar canal (index.html:983)
- `previewPublicationHtmlButton`: Vista imprimible (index.html:991)
- `exportPublicationHtmlButton`: Exportar HTML (index.html:992)
- `exportPublicationMarkdownButton`: Exportar Markdown (index.html:993)
- `copyPublicationTextButton`: Copiar texto (index.html:994)
- `copyPublicationHtmlButton`: Copiar HTML (index.html:995)
- `manualClearSearchButton`: Limpiar búsqueda (index.html:1079)
- `manualExportPdfButton`: Descargar manual PDF (index.html:1080)
- `manualExportHtmlButton`: HTML imprimible (index.html:1081)
- `manualExportMarkdownButton`: Exportar Markdown (index.html:1098)
- `manualMarkAllButton`: Marcar todo (index.html:1099)
- `manualResetReviewButton`: Reiniciar revisión (index.html:1100)
- `openAdvancedDiagnosticsButton`: Diagnostico avanzado (index.html:1117)
- `privacyRecommendedButton`: Aplicar recomendado (index.html:1143)
- `toggleLocalKeyButton`: Mostrar clave (index.html:1144)
- `rotateLocalKeyButton`: Aplicar clave (index.html:1145)
- `unlockLocalButton`: Desbloquear local (index.html:1146)
- `exportAssetInventoryButton`: Exportar inventario (index.html:1198)
- `exportAssetInventoryCsvButton`: CSV inventario (index.html:1199)
- `exportAssetProcessingBacklogButton`: Exportar pendientes (index.html:1200)
- `exportAssetProcessingBacklogCsvButton`: CSV pendientes (index.html:1201)
- `exportAssetProcessingChecklistButton`: Checklist de revisión (index.html:1202)
- `exportAssetMetadataTemplateButton`: Plantilla CSV (index.html:1203)
- `exportAssetEditableMetadataCsvButton`: CSV edición (index.html:1204)
- `suggestFilteredAssetTextButton`: Sugerir texto filtrado (index.html:1205)
- `importAssetMetadataButton`: Importar metadatos (index.html:1206)
- `saveProfileButton`: Guardar perfil (index.html:1264)
