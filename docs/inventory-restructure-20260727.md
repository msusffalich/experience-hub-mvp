...
- Documentos historicos o de soporte: 33.
...
- `clearFormButton`: Limpiar (index.html:337)
- `captureQuickGroupAddButton`: Crear y seleccionar (index.html:355)
- `recordAudioButton`: Grabar audio (index.html:410)
- `clearAssetFiltersButton`: Limpiar filtros (index.html:479)
- `importBiometricAssetButton`: Importar histórico (index.html:504)
- `exportAgendaIcsButton`: Exportar calendario (index.html:542)
- `importAgendaIcsButton`: Importar .ics (index.html:543)
- `agendaSaveBlockedDatesButton`: Guardar bloqueos (index.html:551)
- `agendaClearButton`: Limpiar (index.html:618)
- `agendaSaveButton`: Guardar evento (index.html:619)
- `experienceMapExportButton`: Exportar mapa y notas (index.html:684)
- `connectLocalObsidianVaultButton`: Conectar bóveda del PC (index.html:688)
- `forgetLocalObsidianVaultButton`: Quitar conexión local (index.html:689)
- `experienceMapAskButton`: Consultar (index.html:695)
- `resetReportScopeInlineButton`: Limpiar filtros (index.html:785)
- `generateReportButton`: Generar reporte (index.html:791)
- `downloadEditedReportPdfButton`: Descargar PDF (index.html:792)
- `resetReportScopeButton`: Restaurar vista (index.html:793)
- `clearInsightsScopeButton`: Limpiar filtros (index.html:870)
- `exportInsightsPdfButton`: Descargar PDF de hallazgos (index.html:876)
- `exportInsightsHtmlButton`: Descargar HTML (index.html:877)
- `exportInsightsMarkdownButton`: Exportar Markdown (index.html:878)
- `askButton`: Consultar (index.html:891)
- `clearPublicationScopeButton`: Limpiar filtros (index.html:959)
- `generatePublicationButton`: Generar PDF revista premium (index.html:982)
- `exportPublicationPdfButton`: Descargar PDF revista premium (index.html:983)
- `exportPublicationPackageButton`: Descargar PDF + videos (index.html:984)
- `launchPublicationChannelButton`: Preparar canal (index.html:985)
- `previewPublicationHtmlButton`: Vista imprimible (index.html:993)
- `exportPublicationHtmlButton`: Exportar HTML (index.html:994)
- `exportPublicationMarkdownButton`: Exportar Markdown (index.html:995)
- `copyPublicationTextButton`: Copiar texto (index.html:996)
- `copyPublicationHtmlButton`: Copiar HTML (index.html:997)
- `manualClearSearchButton`: Limpiar búsqueda (index.html:1081)
- `manualExportPdfButton`: Descargar manual PDF (index.html:1082)
- `manualExportHtmlButton`: HTML imprimible (index.html:1083)
- `manualExportMarkdownButton`: Exportar Markdown (index.html:1100)
- `manualMarkAllButton`: Marcar todo (index.html:1101)
- `manualResetReviewButton`: Reiniciar revisión (index.html:1102)
- `openAdvancedDiagnosticsButton`: Diagnostico avanzado (index.html:1119)
- `privacyRecommendedButton`: Aplicar recomendado (index.html:1145)
- `toggleLocalKeyButton`: Mostrar clave (index.html:1146)
- `rotateLocalKeyButton`: Aplicar clave (index.html:1147)
- `unlockLocalButton`: Desbloquear local (index.html:1148)
- `exportAssetInventoryButton`: Exportar inventario (index.html:1200)
- `exportAssetInventoryCsvButton`: CSV inventario (index.html:1201)
- `exportAssetProcessingBacklogButton`: Exportar pendientes (index.html:1202)
- `exportAssetProcessingBacklogCsvButton`: CSV pendientes (index.html:1203)
- `exportAssetProcessingChecklistButton`: Checklist de revisión (index.html:1204)
- `exportAssetMetadataTemplateButton`: Plantilla CSV (index.html:1205)
- `exportAssetEditableMetadataCsvButton`: CSV edición (index.html:1206)
- `suggestFilteredAssetTextButton`: Sugerir texto filtrado (index.html:1207)
- `importAssetMetadataButton`: Importar metadatos (index.html:1208)
- `saveProfileButton`: Guardar perfil (index.html:1266)
