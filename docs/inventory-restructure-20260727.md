...
- Documentos historicos o de soporte: 34.
...
- `clearAssetFiltersButton`: Limpiar filtros (index.html:506)
- `importBiometricAssetButton`: Importar histórico (index.html:531)
- `exportAgendaIcsButton`: Exportar calendario (index.html:569)
- `importAgendaIcsButton`: Importar .ics (index.html:570)
- `agendaSaveBlockedDatesButton`: Guardar bloqueos (index.html:578)
- `agendaClearButton`: Limpiar (index.html:645)
- `agendaSaveButton`: Guardar evento (index.html:646)
- `experienceMapExportButton`: Exportar mapa y notas (index.html:711)
- `connectLocalObsidianVaultButton`: Conectar bóveda del PC (index.html:715)
- `forgetLocalObsidianVaultButton`: Quitar conexión local (index.html:716)
- `experienceMapAskButton`: Consultar (index.html:722)
- `resetReportScopeInlineButton`: Limpiar filtros (index.html:812)
- `generateReportButton`: Generar reporte (index.html:818)
- `downloadEditedReportPdfButton`: Descargar PDF (index.html:819)
- `resetReportScopeButton`: Restaurar vista (index.html:820)
- `clearInsightsScopeButton`: Limpiar filtros (index.html:897)
- `exportInsightsPdfButton`: Descargar PDF de hallazgos (index.html:903)
- `exportInsightsHtmlButton`: Descargar HTML (index.html:904)
- `exportInsightsMarkdownButton`: Exportar Markdown (index.html:905)
- `askButton`: Consultar (index.html:918)
- `clearPublicationScopeButton`: Limpiar filtros (index.html:986)
- `generatePublicationButton`: Generar PDF revista premium (index.html:1009)
- `exportPublicationPdfButton`: Descargar PDF revista premium (index.html:1010)
- `exportPublicationPackageButton`: Descargar PDF + videos (index.html:1011)
- `launchPublicationChannelButton`: Preparar canal (index.html:1012)
- `previewPublicationHtmlButton`: Vista imprimible (index.html:1020)
- `exportPublicationHtmlButton`: Exportar HTML (index.html:1021)
- `exportPublicationMarkdownButton`: Exportar Markdown (index.html:1022)
- `copyPublicationTextButton`: Copiar texto (index.html:1023)
- `copyPublicationHtmlButton`: Copiar HTML (index.html:1024)
- `manualClearSearchButton`: Limpiar búsqueda (index.html:1108)
- `manualExportPdfButton`: Descargar manual PDF (index.html:1109)
- `manualExportHtmlButton`: HTML imprimible (index.html:1110)
- `manualExportMarkdownButton`: Exportar Markdown (index.html:1127)
- `manualMarkAllButton`: Marcar todo (index.html:1128)
- `manualResetReviewButton`: Reiniciar revisión (index.html:1129)
- `openAdvancedDiagnosticsButton`: Diagnostico avanzado (index.html:1146)
- `privacyRecommendedButton`: Aplicar recomendado (index.html:1172)
- `toggleLocalKeyButton`: Mostrar clave (index.html:1173)
- `rotateLocalKeyButton`: Aplicar clave (index.html:1174)
- `unlockLocalButton`: Desbloquear local (index.html:1175)
- `exportAssetInventoryButton`: Exportar inventario (index.html:1227)
- `exportAssetInventoryCsvButton`: CSV inventario (index.html:1228)
- `exportAssetProcessingBacklogButton`: Exportar pendientes (index.html:1229)
- `exportAssetProcessingBacklogCsvButton`: CSV pendientes (index.html:1230)
- `exportAssetProcessingChecklistButton`: Checklist de revisión (index.html:1231)
- `exportAssetMetadataTemplateButton`: Plantilla CSV (index.html:1232)
- `exportAssetEditableMetadataCsvButton`: CSV edición (index.html:1233)
- `suggestFilteredAssetTextButton`: Sugerir texto filtrado (index.html:1234)
- `importAssetMetadataButton`: Importar metadatos (index.html:1235)
- `saveProfileButton`: Guardar perfil (index.html:1293)
