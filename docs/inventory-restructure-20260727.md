...
- `/api/health` (server.js:385)
- `/api/config` (server.js:418)
- `/api/mobile/auth/sign-in` (server.js:429)
- `/api/mobile/auth/refresh` (server.js:452)
- `/api/mobile/assistant/message` (server.js:474)
- `/api/mobile/assistant/status` (server.js:481)
- `/api/mobile/ai/vision` (server.js:488)
- `/api/mobile/assistant/vision` (server.js:488)
- `/api/mobile/ai/messages` (server.js:497)
- `/api/mobile/ai/transcribe` (server.js:504)
- `/api/mobile/realtime/token` (server.js:510)
- `/api/mobile/participants` (server.js:524)
- `/api/mobile/context/daily` (server.js:530)
- `/api/mobile/context/health-summary` (server.js:536)
- `/api/integration/contract` (server.js:542)
- `/api/integration/samples` (server.js:547)
- `/api/integration/oura/manifest` (server.js:552)
- `/api/integration/oura/status` (server.js:557)
- `/api/integration/oura/preflight` (server.js:563)
- `/api/integration/oura/diagnostic-connect` (server.js:568)
- `/api/integration/oura/connect` (server.js:573)
- `/api/integration/oura/connect-url` (server.js:579)
- `/api/integration/oura/callback` (server.js:585)
- `/api/integration/oura/sync` (server.js:590)
- `/api/integration/oura/webhook` (server.js:597)
- `/api/integration/oura/normalize` (server.js:603)
- `/api/integration/apple-health/manifest` (server.js:610)
- `/api/integration/apple-health/normalize` (server.js:615)
- `/api/integration/health-connect/manifest` (server.js:622)
- `/api/integration/health-connect/normalize` (server.js:627)
- `/api/integration/meta-wearables/manifest` (server.js:634)
- `/api/integration/meta-wearables/normalize` (server.js:639)
- `/api/integration/device/selftest` (server.js:646)
- `/api/integration/validate` (server.js:652)
- `/api/integration/ingest` (server.js:659)
- `/api/vibeapp/simulate` (server.js:667)
- `/api/profile` (server.js:673)
- `/api/participants` (server.js:686)
- `/api/account/closure-request` (server.js:704)
- `/api/account/data-reset` (server.js:711)
- `/api/experiences` (server.js:718)
- `/api/agenda` (server.js:732)
- `/api/captures/status` (server.js:745)
- `/api/captures/uploads` (server.js:751)
- `/api/captures/commit` (server.js:759)
- `/api/captures` (server.js:767)
- `/api/v2/status` (server.js:800)
- `/api/v2/evidence` (server.js:806)
- `/api/v2/experiences` (server.js:813)
- `/api/media` (server.js:829)
- `/api/assets` (server.js:855)
- `/api/assets/adopt` (server.js:861)
- `/api/assets/reassign` (server.js:868)
- `/api/upload-attempts` (server.js:882)
- `/api/transcribe` (server.js:897)
- `/api/extract-document` (server.js:904)
- `/api/ocr-image` (server.js:911)
- `/api/translate-text` (server.js:918)
- `/api/search/semantic` (server.js:925)
- `/api/embeddings/backfill` (server.js:932)
- `/api/workspace/backfill` (server.js:939)
- `/api/jobs` (server.js:945)
- `/api/sync/state` (server.js:951)
- `/api/supabase/diagnostics` (server.js:957)
- `/api/supabase/self-test` (server.js:963)
- `/api/routines` (server.js:969)
- `/api/jobs/embeddings` (server.js:975)
- `/api/jobs/asset-processing` (server.js:982)
- `/api/report/pdf` (server.js:1008)
- `/api/insights/pdf` (server.js:1015)
- `/api/publication/pdf` (server.js:1022)
- `/api/manual/pdf` (server.js:1029)
- `/api/exports/file` (server.js:1036)
- `/api/obsidian/export` (server.js:1042)
- `/api/context/impact` (server.js:1049)
- `/api/daily-briefing` (server.js:1059)
- `/api/daily-briefing/latest` (server.js:1069)
