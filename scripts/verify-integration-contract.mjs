...
[
  ...
  "/api/mobile/assistant/status",
  "/api/mobile/realtime/token",
  "/api/mobile/context/daily",
  "/api/mobile/context/health-summary",
  "getMobileDailyContext",
  "getMobileHealthSummary",
  "buildMobileDailyContextResponse",
  "ARNES_ASSISTANT_ENABLED",
  "ARNES_ASSISTANT_URL",
  "ARNES_ASSISTANT_TIMEOUT_MS",
  "proxyMobileAssistantToArnes",
  "getMobileAssistantStatus",
  "vibe-mobile-assistant-status-v1",
  "OPENAI_REALTIME_API_KEY",
  "OPENAI_REALTIME_MODEL",
  "OPENAI_REALTIME_VOICE",
  "createMobileRealtimeToken",
...
assert(files.ouraDoc.includes("/api/integration/ingest") && files.ouraDoc.includes("context_signals") && files.ouraDoc.includes("evidencia intencional"), "Device connector documentation must explain validated ingest, context signals, and intentional evidence behavior.");
...
assert(!files.app.includes("data-dashboard-connect-oura") && !readFileSync("index.html", "utf8").includes("dashboardOuraConnectButton"), "Dashboard must not expose Oura as a daily-user action; connectors belong in Operation/Admin and Vibeapp.");
