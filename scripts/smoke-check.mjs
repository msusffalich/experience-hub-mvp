...
const files = {
  ...
  accountShell: readFileSync("account-shell.js", "utf8"),
...
assert(files.index.includes(`account-shell.js?v=${version}`), "index.html does not load the current account shell version.");
