...
assert(files.app.includes("After signing in, return to Panel and connect Oura again") && files.app.includes("tus datos locales no se borraron"), "Oura connector must show a user-safe auth recovery message.");
