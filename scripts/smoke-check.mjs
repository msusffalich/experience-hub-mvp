...
assert(files.app.includes("Estudio de publicaci") && files.app.includes("Channel publication studio"), "Manual/Admin must document the Publication channel studio.");
