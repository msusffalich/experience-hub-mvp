...
assert(files.app.includes("Playbook del canal") && files.app.includes("Channel playbook") && files.app.includes("Estudio de publicaci") && files.app.includes("Channel publication studio"), "Manual/Admin must document the Publication playbook and channel studio.");
